...
from util import updateTripInfo, getTripInfo
...
trip_info = raw_input("Enter your tripinfo : ") 
...
putResponse = updateTripInfo(tripCompletedInfo)
print("Trip accept information has been updated to Trips table")

getResponse = getTripInfo(
    {
        "riderid" : rider_id,
        "tripinfo" : trip_info 
    })

print("Trip accept information =")
print(getResponse)
