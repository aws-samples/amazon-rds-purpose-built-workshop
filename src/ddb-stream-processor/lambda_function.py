        ...
        if (record['eventName'] == "MODIFY"): #The ride completion event is always an update an existed item for the ride entry
            ...
            if('STATUS' in newInfo and newInfo['STATUS']['S'] == "Completed"):
                ...
                completedtripInfo = {
                    ...
                    "pickup_longitude": "" if 'PICKUP_LONGITUDE' not in newInfo else newInfo['PICKUP_LONGITUDE']['S'],
                    ...
                    "dropoff_latitude": "" if 'DROPOFF_LATITUDE' not in newInfo else newInfo['DROPOFF_LATITUDE']['S'],
                    "rate_code_id": "" if 'RATE_CODE_ID' not in newInfo else newInfo['RATE_CODE_ID']['N'],
                    "tolls_amount": "" if 'TOLLS_AMOUNT' not in newInfo else newInfo['TOLLS_AMOUNT']['S'],
                    "improvement_surcharge": "" if 'IMPROVEMENT_SURCHARGE' not in newInfo else newInfo['IMPROVEMENT_SURCHARGE']['S'],
                    "tip_amount": "" if 'TIP_AMOUNT' not in newInfo else newInfo['TIP_AMOUNT']['S'],
                    ...
                    "pickup_latitude": "" if 'PICKUP_LATITUDE' not in newInfo else newInfo['PICKUP_LATITUDE']['S'],
                    ...
                    "total_amount": "" if 'TOTAL_AMOUNT' not in newInfo else newInfo['TOTAL_AMOUNT']['S'],
                    "mta_tax": "" if 'MTA_TAX' not in newInfo else newInfo['MTA_TAX']['S'],
                    "dropoff_longitude": "" if 'DROPOFF_LONGITUDE' not in newInfo else newInfo['DROPOFF_LONGITUDE']['S'],
