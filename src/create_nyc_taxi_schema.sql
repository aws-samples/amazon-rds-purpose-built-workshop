...
create table trips(
 ...
 SELECT pg_catalog.setval(pg_get_serial_sequence('trips', 'id'),max(2000000)) from payment_types;
 SELECT pg_catalog.setval(pg_get_serial_sequence('billing', 'id'),max(200000)) from payment_types;
 SELECT pg_catalog.setval(pg_get_serial_sequence('payment', 'id'),max(200000)) from payment_types;
commit;
